        ...
        return (
            <>
                ...
                <div className="container-fluid wallpaper-intro">
                    <div className="row">
                        ...
                        <div className="col-lg-10 conteudo-intro">
                            ...
                            <p>
                                Uma empresa de soluções tecnológicas que visa contribuir para a preservação
                                do meio ambiente por meio da reciclagem atrelada a tecnologia. 
                            </p>
                ...
                <footer className="container-fluid rodape">
                    <h1>Mude o planeta de forma divertida e inteligente, <br />começando por você!</h1>
                    <Link to="/signUp">
                        <button>Cadastre-se</button>
                    </Link>
                </footer>
